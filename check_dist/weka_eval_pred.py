...
##
## - Example
##   python weka_eval_pred.py "C45" "" 201604 201605 "norm.fix" "combine" 60 200 80
##
######################################
...
## Constant
## =====================
input_pred_dir = "../../data/check_dist/weka_pred/"
input_data_dir = "../../data/sensor/"
output_dir = "../../data/check_dist/weka_pred/"
fig_dir = "../../data/check_dist/weka_pred/prob/"
...
filename = "%s.weka_%s%d.train%d.%s.%s.nf%d.dup%d%s" % (classifier, sensor, mon1, mon2, type, score, nf, dup, valid)
