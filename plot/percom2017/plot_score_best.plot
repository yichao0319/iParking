...
set ylabel '{/Helvetica=28 Performance}' offset character 2.5, 0, 0
...
# set key at 0,1.2 left reverse Left nobox horizontal spacing 0.9 samplen 2 width -2
set key center bottom left reverse Left nobox horizontal spacing 0.9 samplen 2 width -2
# set nokey
...
###########################################################################
classifier = "C45"
file_name = "score_best"
type = "norm.fix"
typen = "norm_fix"

set output fig_dir.fig_name."_f1.eps"

plot data_dir.file_name.".txt" using 2 with linespoints ls 1 title '{/Helvetica=28 F1-Score}', \
     "" using 3 with linespoints ls 2 title '{/Helvetica=28 Precision}', \
     "" using 4 with linespoints ls 3 title '{/Helvetica=28 Recall}'
