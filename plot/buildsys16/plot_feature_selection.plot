...
#########################################################################
mon=4
file_name = "feature_selection.".mon
fig_name  = "feature_selection.".mon
set output fig_dir.fig_name.".eps"

plot data_dir.file_name.".txt" \
        using 2:xtic(1) t '{/Helvetica=28 All}' fs pattern 2 ls 1, \
     '' using 3 t '{/Helvetica=28 FCBF}' fs pattern 3 ls 2, \
     '' using 4 t '{/Helvetica=28 CFS}' fs pattern 4 ls 3, \
     '' using 5 t '{/Helvetica=28 Gain,N=10}' fs pattern 5 ls 4, \
     '' using 6 t '{/Helvetica=28 Gain,N=30}' fs pattern 6 ls 5, \
     '' using 7 t '{/Helvetica=28 Gain,N=50}' fs pattern 7 ls 6
