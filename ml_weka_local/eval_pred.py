...
f.write("%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f" % (tp, tn, fp, fn, iv, precision, recall, f1, prob_truth_sum, prob_false_sum, prob_fp_sum, prob_fn_sum, accuracy))
f.close()
